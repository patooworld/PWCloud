The SQL Operations Studio project tracks issues and feature requests using the [GitHub issue tracker](https://github.com/Microsoft/sqlopsstudio/issues) for the `sqlopsstudio` repository. 
...
* Version of SQL Operations Studio
